...
$route['^(formKegiatan|addKegiatan|listKegiatan|kegiatanLists|deleteKegiatan|kegiatanById|kegiatanSaya|kegiatanSayaLists|doPemegangKegiatan|detailKegiatan|semuaAnggaranKegiatan|listSemuaAnggaranKegiatan|editAnggaranKegiatan|printKegiatan|listPrintKegiatan)(/:any)?$'] = 'Kegiatan/$0';
...
$route['^(getJ|getO|getRO|getSRO)(/:any)?$'] = 'Belanja/$0';
